...
<body>
	...
	<table id="dg" title="Beneficiary Registration" style="width:100%;height:500px"
			toolbar="#toolbar" pagination="true" idField="id" url="searchbeneficiaries.php" iconCls="icon-search"
		...
		<thead>
            ...
            <th field="project_number" width="50" , data-options="align: 'center', 
				...
				<th field="name_of_beneficiary" id="name_of_beneficiary" width="50" editor="{type:'validatebox',options:{required:true}}">Name of Beneficiary</th>
