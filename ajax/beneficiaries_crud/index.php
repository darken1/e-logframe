	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
			...
			<div class="form-group">
                ...
                <label for="name_of_beneficiary" class="col-sm-2 control-label">Name of beneficiary</label>
				<div class="col-sm-10">
					<input type="text" name="name_of_beneficiary" value="" id="name_of_beneficiary" class="form-control"   />				</div>
			</div>

			<div class="form-group">
				<label for="mothers_name" class="control-label col-sm-2">Mothers name</label>
				<div class="col-sm-10">
					<input type="text" name="mothers_name" value="" id="mothers_name" class="form-control"   />				</div>
			</div>

			<div class="form-group">
				<label for="mothers_name" class="control-label col-sm-2">Next of kin</label>
				<div class="col-sm-10">
					<input type="text" name="next_of_kin" value="" id="mothers_name" class="form-control"   />
