...
class Projectpartnersmodel extends CI_Model {

   private $tbl_roles= 'projectpartners';
   ...
   function get_list() {
	...
	function get_by_project_partner($project_id,$partner_id){
	...
	function delete_project_partner($project_id,$partner_id){
