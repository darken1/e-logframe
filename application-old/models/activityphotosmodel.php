...
**/
class Activityphotosmodel extends CI_Model {

	private $tbl_roles= 'activityphotos';
   ...
   public function get_list()
   {
    ...
    public function get_list_by_activity($projectactivity_id)
   {
       $data = array();
