...
**/
class Rollingactionplanlogsmodel extends CI_Model {

	private $tbl_roles= 'rollingactionplanlogs';
   ...
   {
       $data = array();
       $Q = $this->db->get('rollingactionplanlogs');
       if ($Q->num_rows() > 0) {
   ...
   public function get_list_by_action_plan($rollingactionplan_id)
   {
       $data = array();
