...
**/
class Projectoutcomeindicatorsmodel extends CI_Model {

	private $tbl_roles= 'projectoutcomeindicators';
   ...
   {
       $data = array();
       $Q = $this->db->get('projectoutcomeindicators');
       if ($Q->num_rows() > 0) {
   ...
   public function get_list_by_project($project_id)
   {
    ...
    public function get_list_by_outcome($outcome_id)
   {
       $data = array();
