...
**/
class Projectobjectiveindicatorsmodel extends CI_Model {

	private $tbl_roles= 'projectobjectiveindicators';
   ...
   {
       $data = array();
       $Q = $this->db->get('projectobjectiveindicators');
       if ($Q->num_rows() > 0) {
    ...
    public function get_list_by_objective($objective_id)
   {
       $data = array();
