...
class Projectdonorsmodel extends CI_Model {

   private $tbl_roles= 'projectdonors';
   ...
   function get_list() {
	...
	function get_by_project_donor($project_id,$donor_id){
	...
	function delete_project_donor($project_id,$donor_id){
