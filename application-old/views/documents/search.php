...
echo form_open('documents/searchdocument',$attributes); ?>
									<div class="form-group">
										<label for="county" class="control-label col-sm-2">Document Category</label>
										<div class="col-sm-10">
										<select name="doccategory_id" id="doccategory_id" class="form-control">
										<?php
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
                                            ...
                                            {
                                                ?>
                                                <option value="<?php echo $project['id'];?>" <?php if($user['id']==set_value('project_id')){ echo 'selected="selected"';}?>><?php echo $project['project_title'];?> </option>
                                                <?php
                                            }
                                            ?>
                                            </select>
											...
											foreach($doccategories as $key=>$doccategory)
											{
												...
												if(!empty($documents))
												{
                                                    ...
                                                    <ul>
														...
														?>
														<li id="key<?php echo $doccategory['id'];?>.<?php echo $document['id'];?>"><a href="<?php echo base_url();?>documents/<?php echo $document['file_name'];?>" target="_blank" ><?php echo $document['document_title'];?></a></li>
														<?php
