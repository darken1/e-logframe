		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('activities/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
                ...
                <div id="subsectors">
                    ...
                    {
                        ?>
                        <option value="<?php echo $subsector['id'];?>" <?php if($subsector['id']==$row->subsector_id){ echo 'selected="selected"';}?>><?php echo $subsector['sub_sector'];?></option>
                        <?php
                    }
                    ?>
                    </select>
