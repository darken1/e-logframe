		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('formelements/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Form id</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'form_id', 'name' => 'form_id', 'value' => $row->form_id, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'label', 'name' => 'label', 'value' => $row->label, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'default_value', 'name' => 'default_value', 'value' => $row->default_value, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'tool_tip', 'name' => 'tool_tip', 'value' => $row->tool_tip, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'size', 'name' => 'size', 'value' => $row->size, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'max_length', 'name' => 'max_length', 'value' => $row->max_length, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'rows', 'name' => 'rows', 'value' => $row->rows, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'cols', 'name' => 'cols', 'value' => $row->cols, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'custom_display_format', 'name' => 'custom_display_format', 'value' => $row->custom_display_format, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'folder_path', 'name' => 'folder_path', 'value' => $row->folder_path, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'folder_url', 'name' => 'folder_url', 'value' => $row->folder_url, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'permitted_file_types', 'name' => 'permitted_file_types', 'value' => $row->permitted_file_types, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'max_file_size', 'name' => 'max_file_size', 'value' => $row->max_file_size, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'options', 'name' => 'options', 'value' => $row->options, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'input_type', 'name' => 'input_type', 'value' => $row->input_type, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'required', 'name' => 'required', 'value' => $row->required, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'date_time_created', 'name' => 'date_time_created', 'value' => $row->date_time_created, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'date_time_modified', 'name' => 'date_time_modified', 'value' => $row->date_time_modified, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'listorder', 'name' => 'listorder', 'value' => $row->listorder, 'class'=>'form-control','required'=>'required');
