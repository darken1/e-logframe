		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('savedreports/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Searchparameter</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'searchparameter', 'name' => 'searchparameter', 'value' => $row->searchparameter, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'searchvalue', 'name' => 'searchvalue', 'value' => $row->searchvalue, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'from_year', 'name' => 'from_year', 'value' => $row->from_year, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'from_month', 'name' => 'from_month', 'value' => $row->from_month, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'to_year', 'name' => 'to_year', 'value' => $row->to_year, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'to_month', 'name' => 'to_month', 'value' => $row->to_month, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'reportmethod', 'name' => 'reportmethod', 'value' => $row->reportmethod, 'class'=>'form-control','required'=>'required');
