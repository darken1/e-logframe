			...
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
                ...
                <?php if(validation_errors()){?>
					...
					<?php echo form_open('reports/savereport',$attributes); ?>
                     ...
                     <input type="hidden" name="reportmethod" id="reportmethod" value="projectsbydonorsreport">
                ...
                <thead>
                <tr>
                  <th colspan="2">Report on projects by donors from <?php echo $from_year;?>/<?php echo $from_month;?> to <?php echo $to_year;?>/<?php echo $to_month;?></th></tr>
                </thead>
                    ...
                    <table id="customers">
                    <tr>
                    <td bgcolor="#e31c43"><font color="#FFFFFF"><strong>Projects by donors Table</strong></font>
                    </td>
                    </tr>
                    <tr><td valign="top">
                ...
                <table id="customers">
<tr>
<td bgcolor="#e31c43" width="50%"><font color="#FFFFFF"><strong>Projects by donors pie chart %</strong></font></td>
</tr>
<tr><td>
...
$(function () {
    ...
    $(document).ready(function() {
      ...
      enabled: false
            ...
            title: {
                text: 'Projects Implemented by Donors'
            },
            tooltip: {
            ...
            series: [{
                type: 'pie',
                name: 'Projects implemented by donors',
                data: [
                    <?php echo $piedata;?>
                ]
            }]
