<?php include(APPPATH . 'views/common/head.php'); ?>
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>rolefunctionpermission">rolefunctionpermission</a>
						</li>
					</ul>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('rolefunctionpermission/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Role</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'role', 'name' => 'role', 'value' => $row->role, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'function', 'name' => 'function', 'value' => $row->function, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'permission', 'name' => 'permission', 'value' => $row->permission, 'class'=>'form-control','required'=>'required');
