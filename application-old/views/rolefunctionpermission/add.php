			...
			<div class="form-group">
                ...
                <select multiple="multiple" id="permission" name="permission[]" class='multiselect' required="required">
                	 <?php
											...
											{
												$permissionauthorised = $this->rolefunctionpermissionmodel->check_permission($id,$permission['permission']);	
												...
												?>
                                                <option value='<?php echo $permission['permission'];?>' <?php echo $selected;?>><?php echo $permission['permission'];?></option>
                                                <?php
											}
											?>
