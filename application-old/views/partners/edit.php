		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('partners/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Partner</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'partner', 'name' => 'partner', 'value' => $row->partner, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
                 <select name="organizationtype_id" id="organizationtype_id" class="form-control">
                                                    <?php
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $organizationtype['id'];?>" <?php if($row->organizationtype_id==$organizationtype['id']){echo 'selected="selected"';}?>><?php echo $organizationtype['organization_type'];?></option>
                                                            <?php
                                                        }
                                                        ?>
               </select>
             ...
             <select name="levelofoperation_id" id="levelofoperation_id" class="form-control">
                                                    <?php
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $levelofoperation['id'];?>" <?php if($row->levelofoperation_id==$levelofoperation['id']){echo 'selected="selected"';}?>><?php echo $levelofoperation['level_of_operation'];?></option>
                                                            <?php
                                                        }
                                                        ?>
               </select>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'physical_address', 'name' => 'physical_address', 'value' => $row->physical_address, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'postal_address', 'name' => 'postal_address', 'value' => $row->postal_address, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'postal_code', 'name' => 'postal_code', 'value' => $row->postal_code, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'city', 'name' => 'city', 'value' => $row->city, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'organization_email', 'name' => 'organization_email', 'value' => $row->organization_email, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'telephone', 'name' => 'telephone', 'value' => $row->telephone, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'contact_person', 'name' => 'contact_person', 'value' => $row->contact_person, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'contact_email', 'name' => 'contact_email', 'value' => $row->contact_email, 'class'=>'form-control','required'=>'required');
