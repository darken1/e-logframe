...
**/
class Activitycategoriesmodel extends CI_Model {

	private $tbl_roles= 'activitycategories';
   ...
   {
       $data = array();
       $Q = $this->db->get('activitycategories');
       if ($Q->num_rows() > 0) {
   ...
   public function get_by_category($activity_category)
   {
       $this->db->where('activity_category', $activity_category);
