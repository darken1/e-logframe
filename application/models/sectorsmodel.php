...
class Sectorsmodel extends CI_Model {
   ...
   public function get_list()
   {
    ...
    public function get_by_organization_list($organization_id)
   {
       $data = array();
   ...
   public function get_total_sector($sector_id,$start_date,$end_date)
   {
	   $data = array();
	   
	   $sql = 'SELECT * FROM projects,sectors,projectsectors
   ...
   public function get_total_sector_status($sector_id,$start_date,$end_date,$projectactivitystatus_id)
   {
	   $data = array();
