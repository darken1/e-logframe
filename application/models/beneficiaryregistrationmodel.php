...
**/
class Beneficiaryregistrationmodel extends CI_Model {

	private $tbl_roles= 'beneficiaryregistration';
   ...
   {
       $data = array();
       $Q = $this->db->get('beneficiaryregistration');
       if ($Q->num_rows() > 0) {
   ...
   public function get_by_date($start_date,$end_date)
   {
	   ...
	   WHERE STR_TO_DATE(registration_date,  \'%m/%d/%Y\' )
   ...
   public function count_all()
   {
    ...
    public function get_by_name($name_of_beneficiary)
   {
       $this->db->where('name_of_beneficiary', $name_of_beneficiary);
