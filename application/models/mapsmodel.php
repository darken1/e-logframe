...
class Mapsmodel extends CI_Model {
   ...
   function get_by_project_country_counties($country_id,$county_id)
   {
	   $sql = 'SELECT projectscounties.*,projects.*, projects.id AS projectID, counties.*, counties.id AS countyID ,countries.*
	   FROM projectscounties,projects,counties,countries
