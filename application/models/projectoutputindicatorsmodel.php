...
**/
class Projectoutputindicatorsmodel extends CI_Model {

	private $tbl_roles= 'projectoutputindicators';
   ...
   {
       $data = array();
       $Q = $this->db->get('projectoutputindicators');
       if ($Q->num_rows() > 0) {
   ...
   public function get_list_by_project($project_id)
   {
    ...
    public function get_list_by_output($output_id)
   {
       $data = array();
