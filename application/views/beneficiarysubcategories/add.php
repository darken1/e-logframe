		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('beneficiarysubcategories/add_validate',$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'beneficiary_category', 'name' => 'beneficiary_category','class'=>'form-control','required'=>'required');
            ...
            <div class="form-group">
                ...
                <select name="aggregationtype_id" id="aggregationtype_id" class="form-control">
																		...
																		{
																			?>
                                                                            <option value="<?php echo $aggregationtype['id'];?>" <?php if(set_value('aggregationtype_id')==$aggregationtype['id']){ echo 'selected="selected"';}?>><?php echo $aggregationtype['type'];?></option>
                                                                            <?php
																		}
																		?>
            ...
            <div class="form-group">
                ...
                <select name="gender" id="gender" class="form-control">
                   ...
                   <option value="1" <?php if(set_value('gender')==1){ echo 'selected="selected"';}?>>Male</option>
                   <option value="2" <?php if(set_value('gender')==2){ echo 'selected="selected"';}?>>Female</option>
