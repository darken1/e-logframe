<?php include(APPPATH . 'views/common/head.php'); ?>
		<body>
			...
			<div class="form-group">
				...
				{
					?>
                    <option value="<?php echo $projectactivity['id'];?>"><?php echo $projectactivity['activity'];?></option>
                    <?php
				}
				?>
                </select>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'introduction', 'name' => 'introduction','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'training_induction', 'name' => 'training_induction','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'overal_objective_of_training', 'name' => 'overal_objective_of_training','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'specific_objectives', 'name' => 'specific_objectives','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'methodology', 'name' => 'methodology','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'expectations', 'name' => 'expectations','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'work_shop_norms', 'name' => 'work_shop_norms','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'pre_assessment_results', 'name' => 'pre_assessment_results','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'all_topics_covered', 'name' => 'all_topics_covered','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'key_challenges', 'name' => 'key_challenges','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'recommendations_from_participants', 'name' => 'recommendations_from_participants','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'post_assessment_results', 'name' => 'post_assessment_results','class'=>'form-control','required'=>'required');
										...
										<div class="col-sm-10">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="input-group">
													...
													<input type="file" name="participant_list" id="participant_list" >
													</span>
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="input-group">
													...
													<span class="input-group-addon btn btn-default btn-file">
														<span class="fileinput-new">Select file</span>
													<span class="fileinput-exists">Change</span>
													<input type="file" name="pre_post_assessment_questionnaire" id="pre_post_assessment_questionnaire" >
													</span>
													<a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
												</div>
											</div>
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="input-group">
													...
													<span class="input-group-addon btn btn-default btn-file">
														<span class="fileinput-new">Select file</span>
													<span class="fileinput-exists">Change</span>
													<input type="file" name="training_itinerary" id="training_itinerary" >
													</span>
													<a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
												</div>
											</div>
