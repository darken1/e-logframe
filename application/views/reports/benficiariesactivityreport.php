		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
                ...
                <?php if(validation_errors()){?>
                   ...
                   '<input type="hidden" name="reportmethod" id="reportmethod" value="benficiariesactivityreport">
                ...
                <!--<tr><td>
                    ...
                    <table id="customers">
                    <tr>
                    <td bgcolor="#e31c43"><font color="#FFFFFF"><strong>Beneficiaries reached by activity <?php echo $activity->activity;?> </strong></font>
                    </td>
                    </tr>
                    <tr><td valign="top">
                    <p>
               <?php //echo $reachtable; ?>
                    ...
                    <table id="customers">
                    <tr>
                    <td bgcolor="#e31c43"><font color="#FFFFFF"><strong>Beneficiaries types reached by activity <?php echo $activity->activity;?> </strong></font>
                    </td>
                    </tr>
                    <tr><td valign="top">
                    <p>
               <?php echo $disttable; ?>
                    ...
                    <table id="customers">
                    <tr>
                    <td bgcolor="#e31c43"><font color="#FFFFFF"><strong>Beneficiaries reached </strong></font>
                    </td>
                    </tr>
                    <tr><td valign="top">
