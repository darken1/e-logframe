		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('projectobjectiveindicators/add_validate',$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Indicator</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'indicator', 'name' => 'indicator','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'target', 'name' => 'target','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'means', 'name' => 'means','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'assumptions', 'name' => 'assumptions','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'objective_id', 'name' => 'objective_id','class'=>'form-control','required'=>'required');
