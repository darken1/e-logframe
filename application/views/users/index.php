...
<table class="table table-hover table-nomargin table-bordered dataTable dataTable-column_filter" data-column_filter_types="select,text,text,null,select,select,null" data-column_filter_dateformat="yyyy-mm-dd"  data-nosort="0" data-checkall="all">
<thead>
<tr>
<th>Country</th>
<th>Full Name</th>
