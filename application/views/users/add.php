		...
		<body>
            ...
            <div class="form-group">
				...
				foreach($countries as $key=>$country)
				{
                    ...
                    <select id="county_id" name="county_id" class='form-control' required="required">
                   ...
                   <select id="district_id" name="district_id" class='form-control' required="required">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					?>
                    <?php 
					$data = array('id' => 'email', 'name' => 'email','class'=>'form-control','required'=>'required', 'onKeyPress'=>"checkusername()",'onFocus'=>"checkusername()",'onKeyUp'=>"checkusername()");
 					echo form_input($data, set_value('email'));
					?>
                    <div id="check"></div>
				</div>
