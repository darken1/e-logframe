		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('projectactivitiesbeneficiarycategories/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'beneficiarycategory_id', 'name' => 'beneficiarycategory_id', 'value' => $row->beneficiarycategory_id, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'number_reached', 'name' => 'number_reached', 'value' => $row->number_reached, 'class'=>'form-control','required'=>'required');
