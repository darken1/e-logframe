		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('reportinglines/add_validate',$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
                     ...
                     <option value="0">- None -</option>
                        ...
                        {
                            ?>
                            <option value="<?php echo $reportingline['id']?>" <?php if(set_value('parent_id')==$reportingline['id']){ echo 'selected="selected"';}?>><?php echo $reportingline['title']?></option>
                            <?php
                        }
                        ?>
