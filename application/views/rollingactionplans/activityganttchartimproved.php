...
<link href="https://fonts.googleapis.com/css?family=Lato:400,300,700%7CMaterial+Icons" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>jsgantt/jsgantt.css"/>
<script language="javascript" src="<?php echo base_url(); ?>jsgantt/jsgantt.js"></script>
...
;
// matchMedia polyfill, Author: Scott Jehl, Paul Irish, Nicholas Zakas + Picturefill. Author: Scott Jehl, Filament Group, 2012
...
//-->
		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				?>
					<h3>
						<i class="fa fa-th-list"></i>Project Activity Gantt Chart for <?php echo $project->project_no;?> <?php echo $project->project_title;?>
					</h3>
				</div>
                ...
                <div style="position:relative; display:none; " class="gantt" id="GanttFile"></div>
      <script type="text/javascript">
var g = new JSGantt.GanttChart(document.getElementById('GanttFile'), 'day');
...
if (g.getDivId() != null) {
  ...
  //JSGantt.parseXML('<?php echo base_url(); ?>xml/file_activity<?php echo $plannedactivity_id;?>.xml', g)
  JSGantt.parseXML('<?php echo base_url(); ?>ganttchart/improved/project.xml', g)
