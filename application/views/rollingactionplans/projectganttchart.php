...
<script language="javascript" src="<?php echo base_url(); ?>js/graphics.js"></script>
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
                ...
                <tr>
                <td bgcolor="#FFFF00"><strong>CONSTRUCTION ACTIVITY</strong></td>
                <td bgcolor="#999933"><strong>TRAINING ACTIVITIES</strong></td>
                <td bgcolor="#33FF33"><strong>EVENTS ACTIVITIES</strong></td>
                <td bgcolor="#FF9900"><strong>DISTRIBUTIONS (NFI/FOODS)</strong></td>
                <td bgcolor="#9966CC"><strong>CASH DISTRIBUTIONS</strong></td>
                <td bgcolor="#FF3300"><strong>GROUP FORMATION</strong></td>
                <td bgcolor="#0000ff"><strong>OTHER</strong></td>
                </tr>
                </table>
...
<script>
  ...
  if( g ) {
	...
	JSGantt.parseXML('<?php echo base_url(); ?>xml/file<?php echo $project->project_no;?>.xml',g)
