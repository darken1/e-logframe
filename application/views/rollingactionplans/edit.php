								...
								<div class="tab-content padding tab-content-inline tab-content-bottom">
									<div class="tab-pane active" id="first11">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <option value="<?php echo $county->id;?>" <?php if($county->id==$row->county_id){ echo 'selected="selected"';}?>><?php echo $county->county;?> </option>
                                           <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php 
                                                $data = array('id' => 'task_name', 'name' => 'task_name', 'value' => $row->task_name, 'class'=>'form-control','readonly'=>'readonly');
                                        ...
                                        <div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Activity milestone task</label>
				<div class="col-sm-10">
                
                <div class="check-line">
													<input type="radio" id="primary" class='icheck-me' name="primary" data-skin="square" data-color="orange" value="1" <?php if($row->primary_activity==1){ echo 'checked="checked"';}?> required>
													<label class='inline' for="c12">Yes</label>
												</div>
                                                <div class="check-line">
													<input type="radio" id="primary" class='icheck-me' name="primary" data-skin="square" data-color="orange" value="0" <?php if($row->primary_activity==0){ echo 'checked="checked"';}?> required>
                ...
                <span class="help-block">
									...
									<div class="tab-pane" id="thirds3322">
										<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php 
                                                $data = array('id' => 'start_date', 'name' => 'start_date', 'value' => $row->start_date,'class'=>'form-control datepick','data-inputmask'=>"'mask': '9999-99-99'",'data-date-format'=>'yyyy-mm-dd','readonly'=>'readonly');
                                        ...
                                        <!--<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php 
                                                $data = array('id' => 'start_time', 'name' => 'start_time', 'value' => $row->start_time,'class'=>'form-control','readonly'=>'readonly');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php 
                                                $data = array('id' => 'end_date', 'name' => 'end_date','value' => $row->end_date,'class'=>'form-control datepick','data-inputmask'=>"'mask': '9999-99-99'",'data-date-format'=>'yyyy-mm-dd','readonly'=>'readonly');
                                        ...
                                        <!--<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php 
                                                $data = array('id' => 'end_time', 'name' => 'end_time','value' => $row->end_time, 'class'=>'form-control','readonly'=>'readonly');
