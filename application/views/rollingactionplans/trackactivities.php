...
<script>
   ...
   function trim(str){
	...
	var url = "<?php echo base_url(); ?>index.php/rollingactionplans/tracklist";
			...
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>index.php/rollingactionplans/add">Action plans</a>
						</li>
					</ul>
				...
				<div class="box-content nopadding">
                    ...
                    <table class="table table-nomargin" width="100%">
                                                                <thead>
                                                                	<tr><th colspan="2">ACTIVITY TRACKING</th></tr>
                                                                </thead>
                                                                <tbody>
              <tr><td>
