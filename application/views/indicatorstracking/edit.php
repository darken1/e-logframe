<?php include(APPPATH . 'views/common/head.php'); ?>
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>indicatorstracking">indicatorstracking</a>
						</li>
					</ul>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('indicatorstracking/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Projectoutputindicator id</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'projectoutputindicator_id', 'name' => 'projectoutputindicator_id', 'value' => $row->projectoutputindicator_id, 'class'=>'form-control','required'=>'required');
 					echo form_input($data, set_value('projectoutputindicator_id'));
					?>
				</div>
			</div>
