<?php include(APPPATH . 'views/common/head.php'); ?>
		<body>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'projectoutcomeindicator_id', 'name' => 'projectoutcomeindicator_id','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'comments', 'name' => 'comments','class'=>'form-control','required'=>'required');
