			...
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
                ...
                <div class="col-sm-12">
                    ...
                    <select name="project_id" id="project_id" required="required" class='chosen-select form-control'>
                      ...
                      <tr><th colspan="2">KEY:  <?php
                    foreach($activitycategories as $key=>$activitycategory)
                    {
						$organization = $this->organizationsmodel->get_by_id($activitycategory['organization_id'])->row();
                        ?>
                        <a href="javascript:void(0)" class="tooltip-success" data-rel="tooltip" title="<?php echo $organization->organization_name;?> - <?php echo $activitycategory['activity_category'];?>"><img src="<?php echo base_url();?>img/activity/<?php echo $activitycategory['icon']?>"></a>
                        <?php
