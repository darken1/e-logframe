		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('lockedips/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'reason', 'name' => 'reason', 'value' => $row->reason, 'class'=>'form-control','required'=>'required');
 					echo form_input($data, set_value('reason'));
					?>
				</div>
			</div>
