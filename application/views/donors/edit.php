		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('donors/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Donor name</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'donor_name', 'name' => 'donor_name', 'value' => $row->donor_name, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'email', 'name' => 'email', 'type'=>'email', 'value' => $row->email, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'contact_email', 'name' => 'contact_email', 'type'=>'email', 'value' => $row->contact_email, 'class'=>'form-control','required'=>'required');
