		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('monthlyreports/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'projects_and_beneficiaries', 'name' => 'projects_and_beneficiaries', 'value' => $row->projects_and_beneficiaries, 'class'=>'form-control','required'=>'required');
