			...
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>index.php/monthlyreports">monthlyreports</a>
						</li>
					</ul>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('monthlyreports/add',$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Program area (region)</label>
				<div class="col-sm-10">
                
                
                <select name="programarea_id" id="programarea_id" class="chosen-select form-control">
                		<?php
