		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('beneficiaryregistration/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'next_of_kin', 'name' => 'next_of_kin', 'value' => $row->next_of_kin, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'zero_to_four_female', 'name' => 'zero_to_four_female', 'value' => $row->zero_to_four_female, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'zero_to_four_male', 'name' => 'zero_to_four_male', 'value' => $row->zero_to_four_male, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'programme_area', 'name' => 'programme_area', 'value' => $row->programme_area, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'donor', 'name' => 'donor', 'value' => $row->donor, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'registration_month', 'name' => 'registration_month', 'value' => $row->registration_month, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'registration_date', 'name' => 'registration_date', 'value' => $row->registration_date, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'project_number', 'name' => 'project_number', 'value' => $row->project_number, 'class'=>'form-control','required'=>'required');
