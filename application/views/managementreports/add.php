		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('managementreports/add_validate',$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'describe_security_issues', 'name' => 'describe_security_issues','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'describe_other_developments', 'name' => 'describe_other_developments','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'three_main_issues', 'name' => 'three_main_issues','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'findings_through_tc', 'name' => 'findings_through_tc','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'which_projects_where_closed', 'name' => 'which_projects_where_closed','class'=>'form-control','value'=>$table,'required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'proposals', 'name' => 'proposals','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'issues_related_to_hr', 'name' => 'issues_related_to_hr','class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'issues_to_be_addressed_by_smt', 'name' => 'issues_to_be_addressed_by_smt','class'=>'form-control','required'=>'required');
