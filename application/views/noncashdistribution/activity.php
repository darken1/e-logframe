...
<script>
   ...
   function trim(str){
	...
	var url = "<?php echo base_url(); ?>index.php/projectactivities/getactivities";
...
that.style.backgroundColor = bgcolor;
		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>index.php/noncashdistribution/activity">Non cash distribution</a>
						</li>
					</ul>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('noncashdistribution/add',$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
                <div id="activities">
					<select name="projectaactivity_id" id="projectaactivity_id"  required="required" class='form-control'>
					...
					<div class="form-actions col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-primary">ADD BENEFICIARIES</button>
					</div>
				<?php echo form_close(); ?>
 			</div>
		</div>
