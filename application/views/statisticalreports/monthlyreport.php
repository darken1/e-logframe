...
<div id="tasks_container" style="min-width: 100%; height: 250px; margin: 0 auto"></div>
...
$.ajax({
    ...
    success: function (data) {
        ...
        $.ajax({
			...
			data: {'url':exportUrl,'object':data,'country':country,'month':month,'year':year,'report_id':report_id,},
			success: function (data) {
				// Update "src" attribute with received image URL
...
var options = {
	...
	chart: {
      ...
      enabled: false
            ...
            title: {
                text: 'Beneficiaries reached by sector disaggregated by age & gender'
            },
