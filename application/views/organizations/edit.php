		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('organizations/edit_validate/'.$row->id,$attributes); ?>
			<div class="form-group">
				<label for="textfield" class="control-label col-sm-2">Organization name</label>
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'organization_name', 'name' => 'organization_name', 'value' => $row->organization_name, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'address', 'name' => 'address', 'value' => $row->address, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'country', 'name' => 'country', 'value' => $row->country, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'email', 'name' => 'email', 'value' => $row->email, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'web_address', 'name' => 'web_address', 'value' => $row->web_address,'data-rule-url'=>'true', 'class'=>'form-control','required'=>'required');
