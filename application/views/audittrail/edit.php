		...
		<body>
			<?php include(APPPATH . 'views/common/navigation.php'); ?>
				...
				<div class="box-content nopadding">
					...
					<?php echo form_open('audittrail/edit_validate/'.$row->id,$attributes); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'content', 'name' => 'content', 'value' => $row->content, 'class'=>'form-control','required'=>'required');
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php 
					$data = array('id' => 'user_db_id', 'name' => 'user_db_id', 'value' => $row->user_db_id, 'class'=>'form-control','required'=>'required');
