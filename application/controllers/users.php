   ...
   public function add_validate()
   {
       ...
       if ($this->form_validation->run() == false) {
		   ...
		   //send email to user with the login details
			...
			$this->email->from($from, 'DRC Database');
			$this->email->to($email);
			...
			$content = 'Created user '.$fname.' '.$lname.' of designation '.$designation.' and role '.$role->description.'.';
   ...
   public function edit_validate($id)
   {
       ...
       if ($this->form_validation->run() == false) {
		   ...
		   $designation = $this->input->post('designation');
			...
			$content = 'Edited user '.$fname.' '.$lname.' with designation '.$designation.' and role '.$role->description.'.';
