   ...
   public function edit($id)
   {
	   ...
	   **/
	   ...
	   foreach($projectobjectives as $key=>$projectobjective)
	   {
		   ...
		   {
			   $outcometable .= '<tr><th colspan="4">'.$projectobjective['objective'].'</th>';
	  ...
	  else
	  {
		  //add the objective
		   $data = array(
						   ...
						   'specific_objective' => $specific_objective[0],
					   );
